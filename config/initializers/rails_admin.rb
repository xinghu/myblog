# RailsAdmin config file. Generated on April 16, 2013 11:20
# See github.com/sferik/rails_admin for more informations

RailsAdmin.config do |config|

  config.authorize_with do
    render :text => "ERROR!" unless current_user == User.first
  end

  ################  Global configuration  ################

  # Set the admin name here (optional second array element will appear in red). For example:
  config.main_app_name = ['Hupengxing', 'Admin']
  # or for a more dynamic name:
  # config.main_app_name = Proc.new { |controller| [Rails.application.engine_name.titleize, controller.params['action'].titleize] }

  # RailsAdmin may need a way to know who the current user is]
  config.current_user_method { User.first } # auto-generated
  ...
  # config.excluded_models = ['Blog', 'Book', 'Category', 'Ckeditor::Asset', 'Ckeditor::AttachmentFile', 'Ckeditor::Picture', 'Comment', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Blog', 'Book', 'Category', 'Ckeditor::Asset', 'Ckeditor::AttachmentFile', 'Ckeditor::Picture', 'Comment', 'User']
